...
SNN_SRC = _SRC.parent / "deploy"
TELEMETRY_PATH = str(Path(tempfile.gettempdir()) / "bridge_telemetry.json")
STATE_TSV_PATH = str(Path(tempfile.gettempdir()) / "bridge_state.tsv")
_CONF_DIR = _SRC.parent / "config"
SCENE_CONFIGS = {
